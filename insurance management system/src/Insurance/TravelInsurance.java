...
public class TravelInsurance extends Insurance {private List<String> coveredCountries;
    private int duration;

    public TravelInsurance(List<String> coveredCountries,
                           int duration) {
        super("Seyahat sigortası", 1200, LocalDate.now(), LocalDate.now().plusYears(1));
    ...
    public String toString() {
        return "Seyahat Sigortası [isim=" + getName() + ", ücret=" + getPrice() + ", Başlangıç=" + getStartDate()
                + ", Bitiş=" + getEndDate()
                + ", kapsanan Ülkeler :=" + coveredCountries + ", süre=" + duration + "]";
    }
}