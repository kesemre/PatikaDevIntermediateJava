...
public class CarInsurance extends Insurance{private String carMake;
    ...
    public CarInsurance(String carMake, String carModel,
        ...
        super("Araba Sigortası", 800, LocalDate.now(), LocalDate.now().plusWeeks(3));
    ...
    public String toString() {
        return "Araç sigortası [İsim=" + getName() + ", Ücret=" + getPrice() + ", Başlangıç =" + getStartDate()
                + ", Bitiş Tarihi=" + getEndDate()
                + ", Araba markası =" + carMake + ", Araba modeli =" + carModel + ", Araba yaşı =" + carAge
                + ", Sürücü için kapsam=" + coverageForDrivers + ", Yolcular için kapsam=" + coverageForPassengers
                + "]";
    }
}