...
public class HealthInsurance extends Insurance {
    ...
    public HealthInsurance(String healthCondition,
        ...
        super("Sağlık sigortası", 1000, LocalDate.now(), LocalDate.now().plusMonths(2));
    ...
    public String toString() {
        return "Sağlık Sigortası [İsim =" + getName() + ", Ücret =" + getPrice() + ", Başlangıç tarihi =" + getStartDate()
                + ", Bitiş Tarihi =" + getEndDate()
                + ", sağlık durumu =" + healthCondition + ", Önceki durumlar için kapsam="
                + coverageForPreExistingCondition
                + ", Kapsam sınırı=" + coverageLimit + "]";
    }
}